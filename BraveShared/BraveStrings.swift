...
extension Strings {
    ...
    public static let AddToReadListMenuItem = NSLocalizedString("AddtoReading List", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Add To Reading List", comment: "Title for Add To ReadLis menu item")
