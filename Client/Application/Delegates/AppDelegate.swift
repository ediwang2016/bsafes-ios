...
//        }
    ...
    fileprivate func setUpWebServer(_ profile: Profile) {
        ...
        // Bug 1223009 was an issue whereby CGDWebserver crashed when moving to a background taskhow can I 
    ...
    fileprivate func setUserAgent() {
        let firefoxUA = "BSafes' logic"//UserAgent.defaultUserAgent()
        ...
        FaviconFetcher.userAgent = "BSafes' logic" //UserAgent.desktopUserAgent()
    }
